...
Go to [Kickstart a Maven project](https://docs.akkaserverless.dev/java/kickstart.html) to see how this project was started should you want to build your own Akka Serverless project using Java.
